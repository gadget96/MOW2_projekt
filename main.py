...
headers_boxplot = ['age', 'avg_glucose_level', 'bmi'] # tylko te mają wartości liczbowe, reszta to bardziej klasyfikacja dlatego nie da się wyrysować boxplotów
...
#korelacje
corr1 = df['age'].corr(df['avg_glucose_level']) # korelacja może przyjmować wartości -1 do 1, im bliżej 0 tym korelacja między dwoma parametrami jest mniejsza
